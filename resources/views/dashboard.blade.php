...
<div class="p-8 mt-8">
    <div class="flex items-center justify-between mb-4">
        ...
        <!-- Button on the right -->
        <a href="#" class="text-blue-500 py-2 px-4 text-xl font-bold">
            See All <i class="fa-solid fa-arrow-right"></i>
        </a>
    </div>
    <!-- Scrollable container -->
    <div class="flex flex-wrap gap-4 overflow-y-auto max-h-screen justify-center items-center">

        <!-- Repeat your content blocks here -->
        <div class="block bg-white w-64">
            ...
            <div class="p-2 bg-blue-500 rounded-lg">
                <div class="flex justify-between">
                    <h5 class="mb-2 text-sm font-bold leading-tight text-black">
                        Location Name
                    </h5>
                    <h5 class="mb-2 text-sm font-bold leading-tight text-black flex">
