...
<div class="max-w-2xl mx-auto mt-8">
    <h2 class="my-8 text-xl font-semibold font-mono">Languages</h2>
    @if(isset($experinces))
    ...
    <div class="container flex flex-wrap justify-between items-center mx-auto bg-white rounded-md">
        <div class="text-center border-dashed border-2 border-slate-200 dark:border-black rounded-md w-full p-20">
            <p class="text-xl mb-2 uppercase font-bold dark:text-black">No Languages</p>
            <spam class="text-m text-slate-400 block mb-10 dark:text-black">Add Your Pervious Languages For Your Cv
            </spam>
        </div>
    </div>
    @endif
    <div class="flex items-center justify-between mt-4">
        <a href="{{route('language.form')}}" class="text-gray-500"><i class="fa-solid fa-circle-plus"></i> Add New
            Language</a>
